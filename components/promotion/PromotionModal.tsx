      ...
      isCentered size={["full","full","3xl","3xl"]}>
        ...
        <ModalContent>
          ...
          <Flex pb={30} px={"20px"} flexDir={'column'} overflowY={'auto'} 
            ...
            <Text textTransform={"uppercase"} fontSize={18} fontWeight={700} color={colors.global.primary} my={"20px"}>
              {currentPromo?.name}
            </Text>
            ...
            <UnorderedList ml={10}>
              ...
              <ListItem>{tenancy?.appName}’s <Link color={colors.global.primary} onClick={() => router.push(`/polivies/terms`)}>{t('terms_&_condition')}</Link> {t('applies')}.</ListItem>
            </UnorderedList>
          </Flex>
          ...
          <Center py={"18px"} w={"100%"} gap={1} bgColor={"#303030"}
            ...
            <Text fontWeight={700} fontSize={16} color={colors.global.primary} cursor={'pointer'}>
              {t('customer_care')}
            </Text>
          </Center> 
          </Flex>
